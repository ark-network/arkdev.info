...
const prismIncludeLanguages = (PrismObject) => {
  ...
  PrismObject.languages.btcscript = {
    ...
    'opcode': {
      pattern: /\b(?:OP_)?(?:CHECKSIG|CHECKMULTISIG|RETURN|DUP|HASH160|EQUAL|EQUALVERIFY|VERIFY|CHECKSIGVERIFY|CHECKMULTISIGVERIFY|CHECKSEQUENCEVERIFY|CHECKLOCKTIMEVERIFY|CODESEPARATOR|DROP|2DROP|NIP|OVER|PICK|ROLL|ROT|SWAP|TUCK|SIZE)\b/,
      alias: 'keyword'
    },
    'number': {
      pattern: /-?\b\d+\b/,
