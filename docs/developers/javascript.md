...
1. The WebAssembly file (`main.wasm`)
2. The JavaScript support file (`wasm_exec.js`)

You can obtain these files from our [GitHub Package page](https://github.com/ark-network/ark-sdk/releases).
